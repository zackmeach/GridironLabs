...
- `main_window.py` — maximized window with persistent top nav, a page context bar under the nav, and stacked pages. Home renders a League Leaders grid fed by Parquet stats.
