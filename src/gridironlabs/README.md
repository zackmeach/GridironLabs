...
- `ui` — PySide6 windows and widgets, including the reusable Page → GridCanvas → PanelChrome framework (panel system scaffolding) (see `ui/pages/settings_page.py` for an example).
