...
- Run the desktop shell: `python -m gridironlabs.main`
- (Optional) Scaffold data pulls: `python scripts/bootstrap_data.py`

## Architecture
- `src/gridironlabs/core` — configuration, domain models, repository interfaces.
...
- `src/gridironlabs/ui` — PySide6 windows/widgets; persistent top navigation bar and stacked content area.
