...
- UI note: context bar is 2x nav height and holds all page titles; nav/context/panels share the same surface color.
- UI layout notes (including the static Settings mock) live alongside code in `src/gridironlabs/ui/README.md`.
